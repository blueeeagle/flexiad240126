...
//     }
//   }, [filters, page, selectedCustomers]);
...
//                 <Form.Label className="custom-label">Booked Start Date</Form.Label>
//                 <Form.Control
//                   type="date"
...
//               </Form.Group>
//               <Form.Group className="mb-4">
//                 <Form.Label className="custom-label">Booked End Date</Form.Label>
//                 <Form.Control
//                   type="date"
...
//                 >
//                   <span>
//                     {selectedCustomers.length > 0 ? "Select All" : "Select Customer"}
//                   </span>
//                 </Dropdown.Toggle>
...
//               <th className="min-w-200px">Booking ID</th>
...
//               <th className="min-w-100px">Order Value</th>
//               <th className="min-w-100px">Discount Value</th>
//               <th className="min-w-100px">Net Value</th>
//             </tr>
//           </thead>
//           <tbody>
//             {data.map((dt, idx) => (
...
//                 <td>{dt.currencyId?.currencySymbol || ''} {dt.orderId?.grossAmt || ''}</td>
//                 <td>{dt.currencyId?.currencySymbol || ''} {dt.orderId?.discAmt || ''}</td>
//                 <td>{dt.currencyId?.currencySymbol || ''} {dt.orderId?.netAmt || ''}</td>
//               </tr>
//             ))}
//           </tbody>
//         </table>
